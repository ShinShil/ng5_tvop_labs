...
export const PYATNASHKI: ILabError[] = [
    ...
    },
    {
        ...
        steps: [
            startProgramm,
            'Выбрать пункт меню об авторе',
            'Появится окно "Об авторе"',
            'Подвести курсор мыши к правому краю окно "Об авторе" так, чтобы он принял форму двухсторонней стрелочки',
            'Зажать левую кнопку мыши и ведите курсор мыши влево до тех пор, пока не скроется кнопка "Закрыть"'
        ],
        images: [
            getImage('2_1')
        ],
    ...
    },
    {
        ...
        steps: [
            startProgramm,
            'Выбрать пункт меню "Правила"',
            'Подвести курсор мыши к заголовку окна "ПРавила" - "Правила".',
            'Зажать левую кнопку мыши и переместите курсор мыши в правую сторону так, чтобы стал видно окно с главным меню игры',
            'Выбрать пункт меню "Об авторе"',
            'Появится окно "Об авторе"',
            'Нажать мышкой на заголовок окна с главным меню - диалог об авторе пропал'
        ],
        images: [
            getImage('3_1')
        ],
    ...
    },
    {
        ...
        steps: [
            startProgramm,
            'Максимально быстро водить курсором мыши по пунктам меню'
        ],
        images: [
            getImage('4_1')
        ],
    ...
    },
    {
        ...
        steps: [
            startProgramm,
            'Навести курсор мыши мимо окна с пуктами меню, снизу, так чтобы строго кверху были пункты меню',
            'Максимально быстро провести кусором мыши наверх через всё окно с пунктами меню, конечная тока курсора должна быть вне рабочей области окна с пунктами меню',
            'Повторить предыдущий шаг несколько раз, пока не получится воспроизвести баг, с одновременно выделенными несколькими пунктами меню',
        ],
        images: [
            getImage('5_1')
        ],
    ...
    },
    {
        ...
        steps: [
            'Запустить любое приложение, которое можно развернуть на весь экран, и разверните его на весь экран',
            startProgramm,
            'Развернуть на весь экран приложение из шага 1 и сделайте активным окно тестируемого приложения "Пятнашки"',
